...
export const register = createAsyncThunk<authResponse, RegiterUser, { rejectValue: string }>(
  "user/register",
...
export const login = createAsyncThunk<authResponse, LoginUser, { rejectValue: string }>(
  "user/login",
  async (credential, thunkAPI) => {
    try {
